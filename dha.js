...
petik = '```'
fake = '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 HannGanz'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 HannBOT","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© HannGanz`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 HannGanz", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "HannGanz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6287713882691`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'SIMPLE BUTTON MENU'},type:1},{buttonId: `${prefix}rules`,buttonText:{displayText: 'RULES BOT'},type:1},{buttonId:`${prefix}store`,buttonText:{displayText:'ALL MENU'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 HannGanz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 HannGanz ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 HannGanz`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
       ...
       case 'tebakanime':
              ...
              get_result = await fetchJson(`http://api.lolhuman.xyz/api/tebakchara?apikey=${setting.lolkey}`)
       ...
       case 'kuismath':
              ...
              get_result = await fetchJson(`http://api.lolhuman.xyz/api/kuis/math`)
       ...
       case 'siapaaku':
              ...
              get_result = await fetchJson(`http://api.lolhuman.xyz/api/tebak/siapaaku?apikey=${setting.lolkey}`)
              get_result = get_result.result
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://c.top4top.io/p_21189gxa41.jpg'
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot HannGanz ON 24 Jam*
*1 Hari :* 2K
*1 Minggu :* 10K
*1 Bulan :* 20K
...
//------------------< bayar menu >-------------------  
case 'bayar':
gopeynya = 'hhttps://c.top4top.io/p_21189gxa41.jpg'
teksnya = `*[ PAYMENT ]*
*Gopay :* 087713882691
*Dana :* 087713882691
*Ovo :* 087713882691
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt HannGanz\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI HannGanz\`\`\`')
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©HannGanz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`HannGanz ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
case 'getvn':
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             dha.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 PESAN SIARAN BOT HANN 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran HannGanz 」*\n© HannGanz\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 HannGanz',
			"buttons": [
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6287713882691@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/mr.lucifer086`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/GXq6F4jzi479Oj4QLUdkce')
             break
      case 'ownermenu':
